...
namespace XUnit.Service.Data.Infra
{
    public class QueryRepository : IQueryRepository
    {
        ...
        public Task<List<T>> GetListAsync<T>( CancellationToken cancellationToken = default)
            where T : class
        {
            return GetListAsync<T>(asNoTracking: false, cancellationToken);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            return GetByIdAsync<T>(id, asNoTracking: false, cancellationToken);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public Task<T> GetByIdAsync<T>(
            ...
            where T : BaseEntity<int>
        {
            return GetByIdAsync(id, includes, asNoTracking: false, cancellationToken);
        }
        /// <summary>
        /// 
        /// </summary>
